/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 968c72b3b73b496c0dbf6259158458aa)
// Runtime types generated with workerd@1.20260617.1 2026-06-23 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	KV: KVNamespace;
	DB: D1Database;
	CLERK_PUBLISHABLE_KEY: "pk_test_cHJlbWl1bS1saW9uZXNzLTU0LmNsZXJrLmFjY291bnRzLmRldiQ";
	CLERK_SECRET_KEY: "sk_test_eZR8DXTjyGTOKsV2SPsVI1t1AsDiROcC3MHl5kp9NC";
	NEXT_PUBLIC_SUPABASE_URL: "https://avidmfebskaxheafqpeh.supabase.co";
	SUPABASE_SECRET: "sb_secret_BpFmVgst6Wf1ip4y8J8ZRg_i69_pKjd";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLERK_PUBLISHABLE_KEY" | "CLERK_SECRET_KEY" | "NEXT_PUBLIC_SUPABASE_URL" | "SUPABASE_SECRET">> {}
}
